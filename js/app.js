...
function checkName(){
	...
	if(username.value){
		...
		var initialDiv = document.getElementById('nameDiv');
		var canvasDiv = document.getElementById('wishesDiv');
		initialDiv.className = 'hidden';
		canvasDiv.className = "";
		document.getElementById('showUsername').innerText = username.value; 
	}
	else{
		alert('Enter name')
	}
